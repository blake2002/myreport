...
{
    [Serializable]
    public class QRCodeWrapper : IElement, IBindField, IPmsReportDataBind,
        ...
        ICloneable, IResizable, IDataMapping,IExpression,IElementContent
    {
        ...
        public PMS.Libraries.ToolControls.TwoDCodeLib.Codec.QRCodeEncoder.ENCODE_MODE EncodedMode { get; set; }

        public PMS.Libraries.ToolControls.TwoDCodeLib.Codec.QRCodeEncoder.ERROR_CORRECTION CorrectionLevel { get; set; }
