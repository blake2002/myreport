...
namespace HtmlTags
{
	...
	public class HtmlTag : ITagSource,IDisposable
#if ASPNETCORE
        , IHtmlContent
#else
        , IHtmlString
#endif
    {
		...
		private bool _encodeInnerText = false; 
        ...
        public override string ToString()
        {
			...
			using(var hw=new HtmlTextWriter (sw, string.Empty) { NewLine = string.Empty }) {
				result = ToString (hw);
			}
