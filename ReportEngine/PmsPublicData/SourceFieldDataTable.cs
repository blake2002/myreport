...
{
    [Serializable]
    public  class SourceFieldDataTable : PmsSheet.PmsPublicData.SourceField
    {
        public SourceFieldDataTable()
            : base()
        {
        }
        public SourceFieldDataTable(PmsSheet.PmsPublicData.SourceField Aim)
        {
            base.Name = Aim.Name;
        ...
        public override string Name
        {
            ...
            set
            {
                if (!string.IsNullOrEmpty(value) && this.ParentNode != null && this.ParentNode.TreeView != null)
                {
                    ...
                    {
                        throw new NotImplementedException("表名:" + value + "不合法");
                    }
