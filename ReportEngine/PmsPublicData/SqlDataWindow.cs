...
{
    public class SqlDataWindow : ComboBox
    {
        #region 成员变量
        ...
        public SqlEditorControl SqlEditorControl
        {
            get
            {
                return dataGridViewHost.Control as SqlEditorControl;
            }
        }
        ...
        #endregion
        #region 方法
        #region 绘制SqlEditor以及下拉SqlEditor
        private void DrawSqlEditor()
        {
            SqlEditorControl SqlEditor = new SqlEditorControl();
            //SqlEditor.BackColor = SystemColors.ActiveCaptionText;
            SqlEditor.BorderStyle = BorderStyle.None;
            SqlEditor.OKEvent += new PmsPublicData.SqlEditorControl.OKEventHander(SqlEditor_OKEvent);
            SqlEditor.CancelEvent += new PmsPublicData.SqlEditorControl.CancelEventHander(SqlEditor_CancelEvent);
        ...
        private void ShowDropDown()
        {
            if (dropDown != null)
            {
                ...
                SqlEditorControl.SqlText = this.Text;
