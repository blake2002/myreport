...
namespace PMS.Libraries.ToolControls.PMSChart
{
    ...
    public class MESLegend : PMSLegend
    {
        public MESLegend(Legend Aim)
            : base(Aim)
        {
        }
        ...
        [Description("绑定字段")]
        [Category("MES报表属性")]
        [Editor(typeof(MESLegendEditor), typeof(UITypeEditor))]
        ...
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public List<string> seriesDataForLegend
        {
            get;
            set;
        }
        ...
        #region 属性配置器
        class MESLegendEditor : UITypeEditor
        {
            public override object EditValue(System.ComponentModel.ITypeDescriptorContext context, IServiceProvider provider, object value)
            {
                ...
                {
                    MESLegend pcc = context.Instance as MESLegend;
                            ...
                            foreach (SourceField pdb in lpdb)
                            {
                                try
                                {
                                    if (!string.IsNullOrEmpty(pdb.DataType))
                                    {
                                        ...
                                        {
                                            if (pcc.seriesDataForLegend != null && !pcc.seriesDataForLegend.Contains(pdb.RecordField))
                                            {
