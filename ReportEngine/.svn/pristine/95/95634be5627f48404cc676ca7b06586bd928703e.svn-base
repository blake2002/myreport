...
{
    public class DSDataWindow : ComboBox
    {
        #region 成员变量
        ...
        private void DrawDSSelectControl()
        {
            ...
            SqlEditor.OKEvent += new PmsPublicData.DSSelectControl.OKEventHander(SqlEditor_OKEvent);
            SqlEditor.CancelEvent += new PmsPublicData.DSSelectControl.CancelEventHander(SqlEditor_CancelEvent);
