...
namespace NetSCADA.MESReportServer
{
	...
	public class NLogLogWriter :LogWriter
	{
		...
		{
			if (obj != null)
				_log.Log (GetNLogLevel (level), exception.Message, obj.ToString ());
			else
		...
		{
			if (obj != null)
				_log.Log (LogLevel.Debug, exception.Message, obj.ToString ());
			else
		...
		{
			if (obj != null)
				_log.Log (LogLevel.Info, exception.Message, obj.ToString ());
			else
		...
		{
			if (obj != null)
				_log.Log (LogLevel.Warn, exception.Message, obj.ToString ());
			else
		...
		{
			if (obj != null)
				_log.Log (LogLevel.Error, exception.Message, obj.ToString ());
			else
		...
		{
			if (obj != null)
				_log.Log (LogLevel.Fatal, exception.Message, obj.ToString ());
			else
