...
namespace PMS.Libraries.ToolControls.PMSPublicInfo
{
    ...
    public class PMSTaskbarNotifier : TaskbarNotifier
    {
        #region PMSTaskbarNotifier Constructor
		/// <summary>
        /// The Constructor for PMSTaskbarNotifier
		/// </summary>
        public PMSTaskbarNotifier()
		{
            this.SetBackgroundBitmap(PMSPublicResource.skin,
                    Color.FromArgb(255, 0, 255));
            this.SetCloseBitmap(PMSPublicResource.close,
            ...
            this.EnableSelectionRectangle = true;
            this.KeepVisibleOnMousOver = true;
            this.ReShowOnMouseOver = true;
            //this.TitleClick += new EventHandler(TitleClick);
            //this.ContentClick += new EventHandler(ContentClick);
            //this.CloseClick += new EventHandler(CloseClick);

		}
        
        public void Show(string strTitle, string strContent)
        {
            this.Show(strTitle, strContent, 200, 3000, 200);
        }
		#endregion
    }
}
