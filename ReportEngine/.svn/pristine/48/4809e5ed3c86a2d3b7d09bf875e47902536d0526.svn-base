...
//			}
		...
		string GetCurveChartOption (NetSCADACurve curve, List<string> xData, Dictionary<string,object> xyDataDict, Dictionary<string,List<string[]>> featureTagDict)
		{
...
//			}
		...
		bool CollectedSlice (string serieName, List<object> list, List<string> xData, Dictionary<string,Dictionary<string,string>> fieldNameDict)
		{
			try {
...
//					splitArea = new SplitArea (){ show = true },
		...
		Dictionary<string,List<object>> GetPercent (Dictionary<string,List<string>> datas)
		{
			// 计算系列个百分比
