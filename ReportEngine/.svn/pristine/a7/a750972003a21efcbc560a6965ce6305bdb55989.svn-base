...
namespace Loader
{
    ...
    public class EventBindingServiceImpl : IEventBindingService
    {
        ...
        public EventBindingServiceImpl(IServiceProvider provider)
        {
            if (provider == null)
            {
        ...
        protected bool ShowCode() { return false; }
        ...
        protected bool ShowCode(int lineNumber) { return false; }
        ...
        ///     since we do not generate handler methods.
        protected bool ShowCode(object component, EventDescriptor e, string methodName) { return false; }
        ...
        private class EventPropertyDescriptor : PropertyDescriptor
        {
            ...
            private EventBindingServiceImpl _eventSvc;
            private TypeConverter _converter;

            ///     Creates a new EventPropertyDescriptor.
            internal EventPropertyDescriptor(EventDescriptor eventDesc, EventBindingServiceImpl eventSvc)
                : base(eventDesc, null)
            {
