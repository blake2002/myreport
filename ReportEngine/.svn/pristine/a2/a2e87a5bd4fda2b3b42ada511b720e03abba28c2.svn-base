...
{
    [ToolboxBitmap(typeof(BarCode), "Resources.Barcode.png")]
    [Designer(typeof(MESDesigner))]
    [DefaultProperty("Text")]
    public class BarCode : ElementBase, IExpression, ISuspensionable, IUIDesignExpStruct, IElementTranslator, IDataXmlNodes, IElement, IBindReportExpressionEngine, IProcessCmdKey
    {
        ...
        private TYPE _barCodeType = TYPE.CODE128;
        /// <summary>
        /// 编码方式
        /// </summary>
        [Browsable(true)]
        ...
        private AlignmentPositions _barCodeAlign = AlignmentPositions.CENTER;
        [Browsable(true)]
        [Category("通用")]
        [Description("条形码位置")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        [DefaultValue(0)]
        public AlignmentPositions BarCodeAlign
        {
            get
            {
                return _barCodeAlign;
            }
            set
            {
                _barCodeAlign = value;
