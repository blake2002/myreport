...
namespace Loader
{
    ...
    ///     confusing.
    internal class DesignerSerializationManagerImpl : IDesignerSerializationManager
    {
        private MyCodeAndXMLHostLoader _loader;
        ...
        internal DesignerSerializationManagerImpl(MyCodeAndXMLHostLoader loader)
        {
            _loader = loader;
        }
