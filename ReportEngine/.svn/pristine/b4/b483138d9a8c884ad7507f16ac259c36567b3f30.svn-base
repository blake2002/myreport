...
namespace PMS.Libraries.ToolControls.PMSReport
{
	...
	public class PMSPrintPara : Component, ICloneable, System.ComponentModel.ICustomTypeDescriptor
	{
		...
		public PMSPrintPara ()
		{
			...
			PrintSet = true;
			_DpiX = 96.0f;//PMS.Libraries.ToolControls.PMSPublicInfo.Win32DC.GetDpix();
			_DpiY = 96.0f;//PMS.Libraries.ToolControls.PMSPublicInfo.Win32DC.GetDpiy();
			...
			if (null != this.Site) {
				...
				foreach (IComponent c in this.Site.Container.Components) {
					if (c is System.Windows.Forms.Form) {
						...
						MES.PublicInterface.DesignerForm.SetFormSize (form1, x, y, w, h);
					}
				}
			}
		}
	...
	public class MarginsTypeConverter : ExpandableObjectConverter
	{
		...
		{
			return new StandardValuesCollection (new Margins[] {
				new Margins (12.3f, 5.7f, 6f, 3.17f),
				new Margins (2.54f, 2.54f, 3.18f, 3.18f),
				new Margins (1.27f, 1.27f, 1.27f, 1.27f)
			});
		}
	...
	public class PaperSizeTypeConverter : ExpandableObjectConverter
	{
		...
		public override StandardValuesCollection GetStandardValues (ITypeDescriptorContext context)
		{
			return new StandardValuesCollection (new PaperSize[] {
				new PaperSize ("A3", 29.7f, 42f),
				new PaperSize ("A4", 21f, 29.7f),
				new PaperSize ("16K", 18.41f, 26.67f),
				new PaperSize ("Custom", 21f, 29.7f)
			});
		}
